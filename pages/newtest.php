...
if ($result->num_rows > 0) {
    ...
    $pdf->SetFont('Arial', 'B', 10); // Bold for emphasis
    $pdf->Cell(0, 10, 'Member Status: ' . $member_status, 0, 1, 'C'); // Centered status
    ...
    $pdf->Cell(0, 10, 'Thank you for being a member!', 0, 1, 'C'); // Center footer text
    $pdf->Cell(0, 10, 'For inquiries, contact us at: info@agl.or.ke', 0, 1, 'C'); // Center footer text
