    ...
    <div class="main-content">
        ...
        <section class="dashboard">
            <div class="cards">
                ...
                $sql = "SELECT event_name, event_location, event_date, id, invitation_card FROM event_registrations WHERE member_email = ? ORDER BY event_date ASC";
                $stmt = $conn->prepare($sql);
                ...
                <div class="card">
                    ...
                    if ($resultmessage->num_rows > 0) {
                        while ($row = $resultmessage->fetch_assoc()) {
                            ...
                            echo '<p hidden>' . htmlspecialchars($row['id']) . '</p>';
                            ...
                            echo '<input type="hidden" name="eventName" value="' . htmlspecialchars($row['id']) . '">'; // Pass the event name
