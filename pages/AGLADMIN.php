...
">
    ...
    <div class="logo" style="
        ...
        margin-right: 30px;
    ">
        <img src="../assets/img/logo.png" alt="AGL" style="
            height: 45px;
            width: auto;
            max-width: 180px;
            object-fit: contain;
    ...
    ">
        <a class="innerlinksNav-a" href="#blogPoint" style="
            color: #2C3E50;
            ...
            white-space: nowrap;
        ">Blogs</a>
        <a class="innerlinksNav-a" href="#PlannedEvents" style="
            color: #2C3E50;
            text-decoration: none;
            font-weight: 600;
            font-size: 16px;
            ...
            white-space: nowrap;
        ">Upcoming Events</a>
        <a class="innerlinksNav-a" href="#PastEvents" style="
            color: #2C3E50;
            text-decoration: none;
            font-weight: 600;
            font-size: 16px;
            ...
            white-space: nowrap;
        ">Past Events</a>
        <a class="innerlinksNav-a" id="toggleMessagesReceivedMessages" href="#" style="
            color: #1E5BC6;
            text-decoration: none;
            font-weight: 700;
            font-size: 16px;
    ...
    <!-- Mobile Menu Button -->
    <div id="toggleMenu" class="menu-button" onclick="toggleMenu()" style="
        display: none;
        cursor: pointer;
        font-size: 28px;
        color: #1E5BC6;
    ...
    <!-- Responsive CSS inline as style tag -->
    <style>
        /* Hover effects */
...
<script>
function toggleMenu() {
    const nav = document.querySelector('.innerlinksNav');
    ...
    if (nav.classList.contains('active')) {
        ...
        menuButton.style.backgroundColor = '#1E5BC6';
        menuButton.style.borderColor = '#1E5BC6';
    } else {
        menuButton.innerHTML = '☰';
        menuButton.style.color = '#1E5BC6';
        menuButton.style.backgroundColor = '#F8FAFF';
        menuButton.style.borderColor = '#E3EFFF';
    }
}
