...
<style>
        /* General styles for the event container */
        #eventdiv {
            display: flex;
...
<body>
    ...
    <header class="site-header">
        ...
        <nav class="navigation" id="navigation">
            <ul>
                ...
                <li><a href="https://www.agl.or.ke/">Back</a></li>
            </ul>
        </nav>
    </header>
    ...
    <div id="eventdiv" class="eventdiv">
        ...
        <div class="eventdetails">
            ...
            <div class="eventdetailsdetails"><?php echo htmlspecialchars($event['event_details']); ?></div>
