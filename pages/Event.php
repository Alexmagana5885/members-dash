    ...
    <body>
        ...
        <style>
            ...
            /* Styling headers */
            .eventdetailsdetails h1,
            .eventdetailsdetails h2,
            .eventdetailsdetails h3 {
                color: #0056b3;
            ...
            /* Styling paragraphs */
            .eventdetailsdetails p {
                margin-bottom: 1em;
                /* Space between paragraphs */
            }

            /* Styling lists */
            .eventdetailsdetails ol,
            .eventdetailsdetails ul {
                margin-left: 20px;
                /* Indent lists */
                margin-bottom: 1em;
                /* Space below lists */
            ...
            .eventdetailsdetails blockquote {
        ...
        <div id="eventdiv" class="eventdiv">
            ...
            <div class="eventdetails">
                ...
                <div class="eventdetailsdetails">
                    <?php
                    // Decode the HTML entities before rendering
                    echo html_entity_decode($event['event_details']);
                    ?>
                </div>
